...
object Files {
	...
	*/
	...
	fun getTargetFilename(sources: Array<Filename>): String {
	...
	private fun getExpectedTargetFilename(sources: Array<Filename>): String {
		val sourceList = sources.map { normalize(it) }
